...
session_start();
    ...
    $sql = "SELECT * FROM matches WHERE iduser = '$user' and idMatch in (33,34, 35,36) ";
          ...
          <div class="match-content">
            <div class="column">
              <div class="team team--home">
                ...
                <h2 class="team-name">Corée de sud</h2>
              </div>
            </div>
            <div class="column">
              <div class="match-details">
                <div class="match-date">
                  02 Dec at <strong>16:00</strong>
                </div>
                ...
                <form action="insert.php" method="post" >
                  ...
                  <input type="hidden" name="NBpage" value="02">
                  <input type="hidden" name="date" value="16">

                  
                                  <select id="selectBar" class ="Select" name="selectBar" style="width: 75px;">
                              ...
                              <button name="btn"a class="match-bet-place" type="submit">save pronostics</button>
  ...
  <div class="match" >
    ...
    <div class="match-content">
        ...
        <div class="match-details">
          ...
          <form action="insert.php" method="post" >
            ...
            <input type="hidden" name="date" value="16">
                          ...
                          <select class ="Select" id="id="selectBar1" name="selectBar1" style="width: 75px;">
      ...
      <div class="column">
        <div class="team team--away">
          <div class="team-logo">
            <img src="images/uruguay.png" />
          </div>
          <h2 class="team-name">Uruguay</h2>
        </div>
      </div>
    </div>
  </div><div> <hr  style="height: 15px;border: 0;box-shadow: inset 0 12px 12px -12px rgba(9, 84, 132);"/>
...
function myFunction() {
  ...
  for(let i=0;i<buttons.length;i++){
    ...
    if(currenttdate.getDate()>32||(currenttdate.getDate()==02&&dates[i].value==currenttdate.getHours())){
...
function isEmpty(){
  ...
  else{alert("Your pronostics has been successfully added")};
}    
        </script>
