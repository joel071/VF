...
session_start();
    ...
    $sql = "SELECT * FROM matches WHERE iduser = '$user' and idMatch in (1,2, 3,4) ";
      ...
      <div class="container">
        ...
        <div class="match" >
          ...
          ">
            ...
            <div class="swiper-next-button"><a href="25-matchs.php">
            ...
            <div class="column">
              <div class="match-details">
                ...
                <form action="insert.php" method="post" >
                  ...
                  <input type="hidden" name="NBpage" value="24">
      ...
      <script>let mainNav = document.getElementById("js-menu");
        ...
        function myFunction() {
          ...
          for(let i=0;i<buttons.length;i++){
            if(currenttdate.getDate()<24||(currenttdate.getDate()==24&&dates[i].value==currenttdate.getHours())){
