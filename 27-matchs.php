...
session_start();
    ...
    $sql = "SELECT * FROM matches WHERE iduser = '$user' and idMatch in (13,14, 15,16) ";
...
<div class="swiper-prev-button">
  ...
  <div class="swiper-next-button"><a href="28-matchs.php">
            ...
            <div class="column">
              <div class="match-details">
                ...
                <form action="insert.php" method="post" >
                  ...
                  <input type="hidden" name="NBpage" value="27">
...
function myFunction() {
  ...
  for(let i=0;i<buttons.length;i++){
    ...
    if(currenttdate.getDate()<27||(currenttdate.getDate()==25&&dates[i].value==currenttdate.getHours())){
