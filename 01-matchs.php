...
<div class="swiper-prev-button">
  ...
  <div class="swiper-next-button"><a href="02-matchs.php">
          ...
          <div class="match-content">
            <div class="column">
              <div class="team team--home">
                <div class="team-logo">
                  <img src="images/croitie.png" />
                </div>
                <h2 class="team-name">Croitie</h2>
              </div>
            </div>
            <div class="column">
              <div class="match-details">
                <div class="match-date">
                  01 Dec at <strong>16:00</strong>
                </div>
                ...
                <form action="insert.php" method="post" >
                  ...
                  <input type="hidden" name="NBpage" value="01">
                  <input type="hidden" name="date" value="16">
                                ...
                                <select class ="Select" id="selectBar1" name="selectBar1" style="width: 75px;">
                                  <option value="<?php $first_match_equipe2;?>">
                                  <?php echo $first_match_equipe2 ?>
                                </option>
                                  <option value="0">0</option>
                                  <option value="1">1</option>
                                  <option value="2">2</option>
            ...
            <div class="column">
              <div class="team team--away">
                <div class="team-logo">
                  <img src="images/belgique.png" />
                </div>
                <h2 class="team-name">Belgique</h2>
              </div>
            </div>
          </div>
    ...
    <div class="match-content">
      <div class="column">
        <div class="team team--home">
          ...
          <h2 class="team-name">Australie</h2>
        </div>
      </div>
      <div class="column">
        <div class="match-details">
      ...
      <div class="column">
        <div class="team team--away">
          <div class="team-logo">
            <img src="images/maroc.png" />
          </div>
          <h2 class="team-name">Maroc</h2>
        </div>
      </div>
    </div>
  </div><div> <hr  style="height: 15px;border: 0;box-shadow: inset 0 12px 12px -12px rgba(9, 84, 132);"/>
  ...
  <div class="match" >
    ...
    <div class="match-content">
      <div class="column">
        <div class="team team--home">
          <div class="team-logo">
            <img src="images/japon.png" />
          </div>
          <h2 class="team-name">Japon</h2>
        </div>
      </div>
      <div class="column">
        <div class="match-details">
          <div class="match-date">
            01 Dec at <strong>20:00</strong>
          </div>
          ...
          <form action="insert.php" method="post" >
            ...
            <select class ="Select" id="selectBar" name="selectBar" style="width: 75px;">
                              <option value="<?php $third_match_equipe1;?>"><?php echo $third_match_equipe1 ?></option>
                              <option value="0">0</option>
                              <option value="1">1</option>
                              <option value="2">2</option>
                              <option value="3">3</option>
                          ...
                          <select class ="Select" id="selectBar1" name="selectBar1" style="width: 75px;">
                            <option value="<?php $third_match_equipe2;?>"><?php echo $third_match_equipe2 ?></option>
                            <option value="0">0</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
      ...
      <div class="column">
        <div class="team team--away">
          <div class="team-logo">
            <img src="images/espagne.png" />
          </div>
          <h2 class="team-name">Espagne</h2>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="match-content">
      <div class="column">
        <div class="team team--home">
          ...
          <h2 class="team-name">Costa rica</h2>
        </div>
      </div>
      <div class="column">
        <div class="match-details">
          <div class="match-date">
            01 Nov at <strong>20:00</strong>
          </div>
      ...
      <div class="column">
        <div class="team team--away">
          <div class="team-logo">
            <img src="images/allemagne.png" />
          </div>
          <h2 class="team-name">Allemagne</h2>
        </div>
      </div>
    </div>
  </div>
...
if(currenttdate.getDate()>31||(currenttdate.getDate()==01&&dates[i].value==currenttdate.getHours())){
