...
session_start();
    ...
    $sql = "SELECT * FROM matches WHERE iduser = '$user' and idMatch in (9,10, 11,12) ";
...
* {
 ...
 <div class="swiper-prev-button">
  ...
  <div class="swiper-next-button"><a href="27-matchs.php">
          ...
          <div class="match-content">
            <div class="column">
              <div class="team team--home">
                <div class="team-logo">
                  <img src="images/tunisie.png" />
                </div>
                <h2 class="team-name">Tunisie</h2>
              </div>
            </div>
            <div class="column">
              <div class="match-details">
                <div class="match-date">
                  26 Nov at <strong>11:00</strong>
                </div>
                ...
                <form action="insert.php" method="post" >
                  ...
                  <input type="hidden" name="NBpage" value="26">
  ...
  <div class="match" >
    ...
    <div class="match-content">
      <div class="column">
        <div class="team team--home">
          <div class="team-logo">
            <img src="images/pologne.png" />
          </div>
          <h2 class="team-name">Pologne</h2>
        </div>
      </div>
      <div class="column">
        <div class="match-details">
          <div class="match-date">
            26 Nov at <strong>14:00</strong>
          </div>
      ...
      <div class="column">
        <div class="team team--away">
          ...
          <h2 class="team-name">Arabie saoudite</h2>
        </div>
      </div>
    </div>
  </div><div> <hr  style="height: 15px;border: 0;box-shadow: inset 0 12px 12px -12px rgba(9, 84, 132);"/>
  ...
  <div class="match" >
    ...
    <div class="match-content">
      ...
      <div class="column">
        <div class="team team--away">
          <div class="team-logo">
            <img src="images/danemark.png" />
          </div>
          <h2 class="team-name">Danemark</h2>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="match" >
    ...
    <div class="match-content">
      <div class="column">
        <div class="team team--home">
          <div class="team-logo">
            <img src="images/argentine.png" />
          </div>
          <h2 class="team-name">Argentine</h2>
        </div>
      </div>
      <div class="column">
        <div class="match-details">
          <div class="match-date">
            26 Nov at <strong>20:00</strong>
          </div>
...
function myFunction() {
  ...
  for(let i=0;i<buttons.length;i++){
    ...
    if(currenttdate.getDate()<26||(currenttdate.getDate()==26&&dates[i].value==currenttdate.getHours())){
