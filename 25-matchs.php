...
session_start();
    ...
    $sql = "SELECT * FROM matches WHERE iduser = '$user' and idMatch in (5,6, 7,8) ";
        ...
        <div class="match" >
          <div class="match-header"style=" justify-content: center;">
            <div class="swiper-prev-button">
              ...
              <div class="swiper-next-button"><a href="26-matchs.php">
            ...
            <div class="column">
              <div class="match-details">
                ...
                <form action="insert.php" method="post" >
                  ...
                  <input type="hidden" name="NBpage" value="25">
...
function myFunction() {
  ...
  if(currenttdate.getDate()<25||(currenttdate.getDate()==25&&dates[i].value==currenttdate.getHours())){
